...
class MyUserEditForm(forms.Form):
    ...
    password1 = forms.CharField(label='Clave', widget=forms.PasswordInput, required=False)
    password2 = forms.CharField(label='Repetir Clave', widget=forms.PasswordInput, required=False)
